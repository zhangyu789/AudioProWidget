    ...
    : ElaScrollPage(parent)
{
    ...
    urlCard3->setCardPixmap(QPixmap(":/Resource/Image/Moon.jpg"));
    urlCard3->setTitle("ElaWidgetTool");
    urlCard3->setSubTitle("8009963@qq.com");
    ElaAcrylicUrlCard* urlCard4 = new ElaAcrylicUrlCard(this);
    urlCard4->setUrl("https://space.bilibili.com/21256707");
    urlCard4->setCardPixmap(QPixmap(":/Resource/Image/Moon.jpg"));
    urlCard4->setTitle("ElaWidgetTool");
    urlCard4->setSubTitle("8009963@qq.com");
    ...
    cardScrollAreaWidgetLayout->addWidget(urlCard3);
    cardScrollAreaWidgetLayout->addWidget(urlCard4);

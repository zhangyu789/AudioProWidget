...
void MainWindow::initWindow()
{
    ...
    setUserInfoCardTitle("Audio Pro");
    setUserInfoCardSubTitle("Audio Pro@gmail.com");
...
void MainWindow::initEdgeLayout()
{
    ...
    icon->setPixmap(QPixmap(":/Resource/Image/audio_pro_logo.png"));
    icon->setFixedSize(162, 28);
    icon->setScaledContents(true);


    QLabel* iconFront = new QLabel(this);
    iconFront->setFixedSize(14, 28);
    toolBar->addWidget(iconFront);

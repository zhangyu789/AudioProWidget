#include "SignalStrengthModel.h"

#include <QIcon>
SignalStrengthModel::SignalStrengthModel(QObject* parent)
...
int SignalStrengthModel::rowCount(const QModelIndex& parent) const
{
    return _dataList.count();
}

int SignalStrengthModel::columnCount(const QModelIndex& parent) const
{
    return _header.count();
}

QVariant SignalStrengthModel::data(const QModelIndex& index, int role) const
{
...
QVariant SignalStrengthModel::headerData(int section, Qt::Orientation orientation, int role) const
{
